...
const routes = [
  ...
  {path:'/pagos/spei', name: 'pago_spei', component: ()=> import ('@/views/carrito/pagoSPEIApp.vue'),meta: { requiresAuth: false }},
  {path:'/cuenta/ordenes', name: 'ordenes_cliente', component: ()=> import ('@/views/cliente/ordenesClienteApp.vue'),meta: { requiresAuth: false }}
]
